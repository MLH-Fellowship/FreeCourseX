        ...
        <div className="bg-yellow-50 pb-4">
            <div className="h-screen flex flex-col justify-center items-center">
                ...
                <div className="flex flex-row items-end h-3/5 ">
                    ...
                    <Link to="/form">
                        <button type="button" className="top-3 h-10 px-4 py-2 mb-10 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none">get started</button>
                    </Link>
                </div>
            </div>
            ...
            <div className="h-screen flex flex-col justify-center text-center">
                ...
                <div className="flex flex-row mx-4">
                    <div className="flex flex-wrap content-between justify-center w-1/3 bg-blue-300 hover:bg-blue-200 py-8 px-3 mx-5 rounded shadow-md hover:shadow-xl">
